      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
            <div className="col-span-2">
              ...
              <p className="mt-4 text-base text-gray-600 max-w-sm">
                The ultimate platform for unified e-commerce management, helping sellers reach customers across multiple marketplaces.
              </p>
        ...
        <div className="border-t border-gray-200 py-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-600 mb-4 md:mb-0">
            © {year} Sumimaase. All rights reserved.
          </p>
