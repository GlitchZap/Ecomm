...
const Footer = ({ className = "" }) => {
  ...
  return (
    <footer className={`bg-gray-800 text-white mt-6 ${className}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li><Link to="/ai-support" className="hover:text-white">AI Support</Link></li>
              <li><Link to="/pricing" className="hover:text-white">Pricing Plans</Link></li>
              <li><Link to="/help" className="hover:text-white">How to Sell</Link></li>
              <li><Link to="/profile" className="hover:text-white">Account Settings</Link></li>
            </ul>
          </div>
          
          <div>
            <h3 className="text-lg font-semibold mb-4">Selling Platforms</h3>
            <ul className="space-y-2 text-sm text-gray-400">
          ...
          <div>
            ...
            <div className="mt-4">
              <button className="bg-gray-600 hover:bg-gray-700 text-white py-2 px-4 rounded-md text-sm">
                Contact Support
              </button>
            </div>
          </div>
